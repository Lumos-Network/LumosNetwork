...
void forward_global_avgpool_layer_gpu(Layer l, int num)
{
    for (int i = 0; i < num; ++i)
    {
        ...
        global_avgpool_gpu(input, l.input_h, l.input_w, l.input_c, output);
    }
}
...
void backward_global_avgpool_layer_gpu(Layer l, int num, float *n_delta)
{
    for (int i = 0; i < num; ++i)
    {
        ...
        global_avgpool_gradient_gpu(delta_l, l.input_h, l.input_w, l.input_c, delta_n);
    }
}

void zerograd_global_avgpool_layer_gpu(Layer l, int subdivision)
{
