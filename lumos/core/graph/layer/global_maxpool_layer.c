...
Layer *make_global_maxpool_layer()
{
    ...
    l->zerogradlayer = zerograd_global_maxpool_layer;
    l->zerogradlayergpu = zerograd_global_maxpool_layer_gpu;
...
void zerograd_global_maxpool_layer(Layer l, int subdivision)
{
