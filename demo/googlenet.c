...
void googlenet(char *type, char *path)
{
    ...
    ls[0] = make_convolutional_layer(64, 7, 2, 3, 0, 0, "linear");
    ls[1] = make_normalization_layer(0.1, 1, "relu");
    ls[2] = make_maxpool_layer(3, 2, 1);
    ls[3] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ls[4] = make_convolutional_layer(192, 3, 1, 1, 0, 0, "linear");
    ls[5] = make_normalization_layer(0.1, 1, "relu");
    ls[6] = make_maxpool_layer(3, 2, 1);

    ls[7] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");

    ls[8] = make_shortcut_layer(ls[7], 1, "linear");
    ls[9] = make_convolutional_layer(96, 1, 1, 0, 0, 1, "relu");
    ls[10] = make_convolutional_layer(128, 3, 1, 1, 0, 1, "relu");

    ls[11] = make_shortcut_layer(ls[7], 1, "linear");
    ls[12] = make_convolutional_layer(16, 1, 1, 0, 0, 1, "relu");
    ls[13] = make_convolutional_layer(32, 5, 1, 2, 0, 1, "relu");

    ls[14] = make_shortcut_layer(ls[7], 1, "linear");
    ls[15] = make_maxpool_layer(3, 1, 1);
    ls[16] = make_convolutional_layer(32, 1, 1, 0, 0, 1, "relu");
    ...
    ls[18] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu"); // 16

    ls[19] = make_shortcut_layer(ls[18], 1, "linear");
    ls[20] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu");
    ls[21] = make_convolutional_layer(192, 3, 1, 1, 0, 1, "relu");

    ls[22] = make_shortcut_layer(ls[18], 1, "linear");
    ls[23] = make_convolutional_layer(32, 1, 1, 0, 0, 1, "relu");
    ls[24] = make_convolutional_layer(96, 5, 1, 2, 0, 1, "relu");

    ls[25] = make_shortcut_layer(ls[18], 1, "linear");
    ls[26] = make_maxpool_layer(3, 1, 1);
    ls[27] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ...
    ls[30] = make_convolutional_layer(192, 1, 1, 0, 0, 1, "relu");

    ls[31] = make_shortcut_layer(ls[30], 1, "linear");
    ls[32] = make_convolutional_layer(96, 1, 1, 0, 0, 1, "relu");
    ls[33] = make_convolutional_layer(208, 3, 1, 1, 0, 1, "relu");

    ls[34] = make_shortcut_layer(ls[30], 1, "linear");
    ls[35] = make_convolutional_layer(16, 1, 1, 0, 0, 1, "relu");
    ls[36] = make_convolutional_layer(48, 5, 1, 2, 0, 1, "relu");

    ls[37] = make_shortcut_layer(ls[30], 1, "linear");
    ls[38] = make_maxpool_layer(3, 1, 1);
    ls[39] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ...
    // 辅助分类器位置
    ls[41] = make_convolutional_layer(160, 1, 1, 0, 0, 1, "relu"); // 39

    ls[42] = make_shortcut_layer(ls[41], 1, "linear");
    ls[43] = make_convolutional_layer(112, 1, 1, 0, 0, 1, "relu");
    ls[44] = make_convolutional_layer(224, 3, 1, 1, 0, 1, "relu");

    ls[45] = make_shortcut_layer(ls[41], 1, "linear");
    ls[46] = make_convolutional_layer(24, 1, 1, 0, 0, 1, "relu");
    ls[47] = make_convolutional_layer(64, 5, 1, 2, 0, 1, "relu");

    ls[48] = make_shortcut_layer(ls[41], 1, "linear");
    ls[49] = make_maxpool_layer(3, 1, 1);
    ls[50] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ...
    ls[52] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu"); // 50

    ls[53] = make_shortcut_layer(ls[52], 1, "linear");
    ls[54] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu");
    ls[55] = make_convolutional_layer(256, 3, 1, 1, 0, 1, "relu");

    ls[56] = make_shortcut_layer(ls[52], 1, "linear");
    ls[57] = make_convolutional_layer(24, 1, 1, 0, 0, 1, "relu");
    ls[58] = make_convolutional_layer(64, 5, 1, 2, 0, 1, "relu");

    ls[59] = make_shortcut_layer(ls[52], 1, "linear");
    ls[60] = make_maxpool_layer(3, 1, 1);
    ls[61] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ...
    ls[63] = make_convolutional_layer(112, 1, 1, 0, 0, 1, "relu"); // 61

    ls[64] = make_shortcut_layer(ls[63], 1, "linear");
    ls[65] = make_convolutional_layer(144, 1, 1, 0, 0, 1, "relu");
    ls[66] = make_convolutional_layer(288, 3, 1, 1, 0, 1, "relu");

    ls[67] = make_shortcut_layer(ls[63], 1, "linear");
    ls[68] = make_convolutional_layer(32, 1, 1, 0, 0, 1, "relu");
    ls[69] = make_convolutional_layer(64, 5, 1, 2, 0, 1, "relu");

    ls[70] = make_shortcut_layer(ls[63], 1, "linear");
    ls[71] = make_maxpool_layer(3, 1, 1);
    ls[72] = make_convolutional_layer(64, 1, 1, 0, 0, 1, "relu");
    ...
    // 辅助分类器位置
    ls[74] = make_convolutional_layer(256, 1, 1, 0, 0, 1, "relu"); // 72

    ls[75] = make_shortcut_layer(ls[74], 1, "linear");
    ls[76] = make_convolutional_layer(160, 1, 1, 0, 0, 1, "relu");
    ls[77] = make_convolutional_layer(320, 3, 1, 1, 0, 1, "relu");

    ls[78] = make_shortcut_layer(ls[74], 1, "linear");
    ls[79] = make_convolutional_layer(32, 1, 1, 0, 0, 1, "relu");
    ls[80] = make_convolutional_layer(128, 5, 1, 2, 0, 1, "relu");

    ls[81] = make_shortcut_layer(ls[74], 1, "linear");
    ls[82] = make_maxpool_layer(3, 1, 1);
    ls[83] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu");
    ...
    ls[86] = make_convolutional_layer(256, 1, 1, 0, 0, 1, "relu");

    ls[87] = make_shortcut_layer(ls[86], 1, "linear");
    ls[88] = make_convolutional_layer(160, 1, 1, 0, 0, 1, "relu");
    ls[89] = make_convolutional_layer(320, 3, 1, 1, 0, 1, "relu");

    ls[90] = make_shortcut_layer(ls[86], 1, "linear");
    ls[91] = make_convolutional_layer(32, 1, 1, 0, 0, 1, "relu");
    ls[92] = make_convolutional_layer(128, 5, 1, 2, 0, 1, "relu");

    ls[93] = make_shortcut_layer(ls[86], 1, "linear");
    ls[94] = make_maxpool_layer(3, 1, 1);
    ls[95] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu");
    ...
    ls[97] = make_convolutional_layer(384, 1, 1, 0, 0, 1, "relu"); // 95

    ls[98] = make_shortcut_layer(ls[97], 1, "linear");
    ls[99] = make_convolutional_layer(192, 1, 1, 0, 0, 1, "relu");
    ls[100] = make_convolutional_layer(384, 3, 1, 1, 0, 1, "relu");

    ls[101] = make_shortcut_layer(ls[97], 1, "linear");
    ls[102] = make_convolutional_layer(48, 1, 1, 0, 0, 1, "relu");
    ls[103] = make_convolutional_layer(128, 5, 1, 2, 0, 1, "relu");

    ls[104] = make_shortcut_layer(ls[97], 1, "linear");
    ls[105] = make_maxpool_layer(3, 1, 1);
    ls[106] = make_convolutional_layer(128, 1, 1, 0, 0, 1, "relu");
