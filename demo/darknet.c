...
void darknet(char *type, char *path)
{
    ...
    Layer *l1 = make_convolutional_layer(16, 3, 1, 1, 0, 1, "linear");
    Layer *l2 = make_normalization_layer(0.1, 1, "relu");
    Layer *l3 = make_maxpool_layer(2, 2, 0);
    Layer *l4 = make_convolutional_layer(32, 3, 1, 1, 0, 1, "linear");
    Layer *l5 = make_normalization_layer(0.1, 1, "relu");
    Layer *l6 = make_maxpool_layer(2, 2, 0);
    Layer *l7 = make_convolutional_layer(64, 3, 1, 1, 0, 1, "linear");
    Layer *l8 = make_normalization_layer(0.1, 1, "relu");
    Layer *l9 = make_maxpool_layer(2, 2, 0);
    Layer *l10 = make_convolutional_layer(128, 3, 1, 1, 0, 1, "linear");
    Layer *l11 = make_normalization_layer(0.1, 1, "relu");
    Layer *l12 = make_maxpool_layer(2, 2, 0);
    Layer *l13 = make_convolutional_layer(256, 3, 1, 1, 0, 1, "linear");
    Layer *l14 = make_normalization_layer(0.1, 1, "relu");
    Layer *l15 = make_maxpool_layer(2, 2, 0);
    Layer *l16 = make_convolutional_layer(512, 3, 1, 1, 0, 1, "linear");
    Layer *l17 = make_normalization_layer(0.1, 1, "relu");
    Layer *l18 = make_maxpool_layer(2, 2, 0);
    Layer *l19 = make_convolutional_layer(1024, 3, 1, 1, 0, 1, "linear");
    Layer *l20 = make_normalization_layer(0.1, 1, "relu");
    Layer *l21 = make_avgpool_layer(3, 3, 0);
    Layer *l22 = make_convolutional_layer(20, 1, 1, 0, 0, 1, "linear");
    Layer *l23 = make_crossentropy_layer(NULL, -1);
    ...
    Session *sess = create_session(graph, 224, 224, 3, 1, 20, type, path);
...
void darknet_detect(char*type, char *path)
{
    ...
    Layer *l11 = make_normalization_layer(0.1, 1, "relu");
    Layer *l12 = make_maxpool_layer(2, 2, 0);
    Layer *l13 = make_convolutional_layer(224, 3, 1, 1, 0, 1, "linear");
    Layer *l14 = make_normalization_layer(0.1, 1, "relu");
    Layer *l15 = make_maxpool_layer(2, 2, 0);
    Layer *l16 = make_convolutional_layer(512, 3, 1, 1, 0, 1, "linear");
    Layer *l17 = make_normalization_layer(0.1, 1, "relu");
    ...
    Layer *l22 = make_convolutional_layer(5, 1, 1, 0, 0, 1, "linear");
    Layer *l23 = make_crossentropy_layer(NULL, -1);
    append_layer2grpah(graph, l1);
    append_layer2grpah(graph, l2);
    append_layer2grpah(graph, l3);
